...
Pots is an e-commerce store for rare and trendy plants. The goal was to build a fully functional shopping experience end-to-end, from browsing products to paying with Stripe. The project included designing the branding and visual identity. The design for some pages are currently in progress.
