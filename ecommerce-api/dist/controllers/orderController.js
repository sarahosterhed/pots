...
exports.deleteOrder = exports.updateOrder = exports.createOrder = exports.getOrderByPaymentId = exports.getOrderById = exports.getOrders = void 0;
...
const getOrderByPaymentId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    try {
        const sql = `
      SELECT 
...
exports.getOrderByPaymentId = getOrderByPaymentId;
